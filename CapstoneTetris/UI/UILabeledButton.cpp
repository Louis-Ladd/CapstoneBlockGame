...
UILabeledButton::UILabeledButton(int x, int y, int w, int h, SDL_Color text_color, SDL_Color button_color, TTF_Font* label_font, SDL_Renderer* renderer, std::string text)
{
